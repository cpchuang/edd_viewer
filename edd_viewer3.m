...
% $Revision: 1.5.2 $  $Date: 2020/01/16 $
...
if isempty(heddviewMain)
    ...
    %
    config.visopt.Inst.detpar  = [5 0 0.03 0 ;...
                                  5 0 0.03 0]; % [TOA p0 p1 p2], 
...
hcopyright = text('Parent',hAxes,...
    ...
    'fontsize',8,...
    'String',{'by AC@APS, ANL','Ver.1.5.2 January. 2020'},...
...
heditVisOpt(15) = uicontrol('Style','CheckBox',...
    'Parent',hGroupPanel_Vis,...
    'units','pixels',...
    'Position',[celpos(1,7,config.size.edbox4,5)+[5 9] 85 15],...
    'backgroundcolor',config.color.textbg,...
    'fontsize',config.fs.edbox-4,...
    'String',{'step_plot'},...
